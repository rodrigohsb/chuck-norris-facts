...
class HomeActivity: BaseActivity() {
    ...
    override fun showEmptyView() { textView.visibility = View.VISIBLE }
    override fun hideEmptyView() { textView.visibility = View.GONE }

    override fun showLoadingView() { loading.visibility = View.VISIBLE }
    override fun hideLoadingView() { loading.visibility = View.GONE }

    override fun showTimeoutView() { textView.visibility = View.VISIBLE }
    override fun hideTimeoutView() { textView.visibility = View.GONE }

    override fun showGenericErrorView() { textView.visibility = View.VISIBLE }
    override fun hideGenericErrorView() { textView.visibility = View.GONE }

    override fun showNoConnectionView() { textView.visibility = View.VISIBLE }
    override fun hideNoConnectionView() { textView.visibility = View.GONE }
}