...
import br.com.chucknorrisfacts.webservice.exceptions.NoNetworkException
 ...
 * @rodrigohsb
 */
class HomeActivityNoNetworkTest : AcceptanceTest<HomeActivity>(HomeActivity::class.java) {
